                    ...
                    {organization.website && (
                      <div className="flex gap-2 min-w-0">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          >
                            {formatOrganizationWebsiteDisplay(
                              organization.website,
                            )}
                          </Link>
                        </div>
            ...
            {pluginOverviewExtensions.length > 0 && (
              <Card className="overflow-hidden">
                <CardHeader>
                  ...
                  <CardDescription>
                    Organization-specific experience modules contributed by
                    installed plugins.
                  </CardDescription>
                </CardHeader>
                          ...
                          <DialogContent className="sm:max-w-2xl">
                            <DialogHeader>
                              ...
                              <DialogDescription className="text-center text-base">
                                Get your organization verified to build trust
                              ...
                              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                ...
                                <div className="flex items-center gap-3 p-3 border rounded-lg hover:bg-muted/50 cursor-pointer">
                                  ...
                                  <div>
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                      Provide proof of volunteer hours and
                                      initiatives
                                    </p>
                                  </div>
                                </div>
                                ...
                                <div className="flex items-center gap-3 p-3 border rounded-lg hover:bg-muted/50 cursor-pointer">
                                  ...
                                  <div>
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                      Submit registration certificates or
                                      credentials
                                    </p>
                                  </div>
                                </div>
