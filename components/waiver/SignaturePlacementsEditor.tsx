...
export function SignaturePlacementsEditor({
  ...
  const handlePlacementFieldTypeChange = (
        ...
        <div className="space-y-2 pb-4">
          {placements.length === 0 ? (
            <div className="text-xs text-muted-foreground p-6 text-center border-2 border-dashed rounded-lg bg-muted/20">
              ...
              <p>
                Add a new label, then pick the field type and signer details.
              </p>
            </div>
          ) : (
                    ...
                    <div className="flex-1 space-y-2">
                      <div className="flex items-center gap-2">
                        ...
                        <div className="w-24 shrink-0">
                          <Select
                            value={normalizeCustomPlacementFieldType(
                              placement.fieldType,
                            )}
                            onValueChange={(val) =>
                              val &&
                              handlePlacementFieldTypeChange(placement, val)
                            }
                          >
                            <SelectTrigger
                            ...
                            <SelectContent>
                              {CUSTOM_PLACEMENT_FIELD_TYPE_OPTIONS.map(
                                (option) => (
                                  <SelectItem
                                    key={option.value}
                                    value={option.value}
