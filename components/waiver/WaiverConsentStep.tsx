      ...
      <div className="flex items-start space-x-3">
        ...
        <div className="space-y-1">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            By attempting to sign, I confirm that I have read the waiver
            document, understand its contents, and agree to its terms. I
            understand that my electronic signature has the same legal effect
            and validity as a written signature.
          </p>
        </div>
      </div>
    </div>
