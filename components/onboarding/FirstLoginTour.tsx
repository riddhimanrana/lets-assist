...
export default function FirstLoginTour({ isOpen, onComplete, onSkip }: FirstLoginTourProps) {
  ...
  useEffect(() => {
    ...
    style.textContent = `
/* Hide all overlays/backdrops during tour */
body[data-first-login-tour='true'] [data-portal] > [data-dialog-backdrop],
body[data-first-login-tour='true'] .base-Dialog-backdrop {
