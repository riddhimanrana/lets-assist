...
At this guide's current evidence point, the repository has 284 migrations
through `20260813013100`; the Development database remains at 273 through
`20260812152300`; and Production has 236 through `20260811001500`. The eleven
...
the 284-migration repository tree.
...
- Hosted Development Supabase remains at 273 ordered migrations through
  `20260812152300_atomic_csf_post_replies`; this repository has 284 through
  `20260813013100_lock_project_lifecycle_transactions`. The eleven unmerged
  migrations are
  ...
  `20260813013100_lock_project_lifecycle_transactions`; they have not been
...
- The 95 INFO / 0 WARN / 0 ERROR security and 611 INFO / 0 WARN / 0 ERROR
  ...
  repository 284 and are not current-parity evidence.
...
- [ ] Run the read-only
      ...
      review. Rehearse the full 48-migration transition on a Production-shaped
...
- [ ] Replay the ordered migration ledger through `20260813013100` in the
...
- [ ] Re-run the preflight on the 284-row target and require the shared tenant
