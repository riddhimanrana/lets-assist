...
`20260812152300`; and Production has 236 through `20260811001500`. The six
...
the 279-migration repository tree.
...
- Hosted Development Supabase remains at 273 ordered migrations through
  `20260812152300_atomic_csf_post_replies`; this repository has 279 through
  `20260813012206_google_cap_effect_fencing`. The six unmerged migrations are
