...
`20260812152300`; and Production has 236 through `20260811001500`. The two
unmerged Google CAP migrations have not been applied or deployed in hosted Development.
...
the 275-migration repository tree.
...
- Hosted Development Supabase remains at 273 ordered migrations through
  ...
  `20260813012206_google_cap_effect_fencing`. The unmerged migrations have not been
...
- The 95 INFO / 0 WARN / 0 ERROR security and 611 INFO / 0 WARN / 0 ERROR
  ...
  evidence for the repository's 275-migration target.
