...
through `20260812193329`; the Development database remains at 273 through
`20260812152300`; and Production has 236 through `20260811001500`. The unmerged
Google CAP migration has not been applied or deployed in hosted Development.
...
the 274-migration repository tree.
...
- Hosted Development Supabase remains at 273 ordered migrations through
  `20260812152300_atomic_csf_post_replies`; this repository has 274 through
  `20260812193329_google_cap_replay_safety`. The unmerged migration has not been
  applied or deployed there.
- The 95 INFO / 0 WARN / 0 ERROR security and 611 INFO / 0 WARN / 0 ERROR
  ...
  evidence for the repository's 274-migration target.
...
- [ ] Replay the ordered migration ledger through `20260812193329` in the
