...
At this guide's current evidence point, the repository has 285 migrations
through `20260813020000`; the Development database remains at 273 through
`20260812152300`; and Production has 236 through `20260811001500`. The twelve
...
the 285-migration repository tree.
...
- Hosted Development Supabase remains at 273 ordered migrations through
  `20260812152300_atomic_csf_post_replies`; this repository has 285 through
  `20260813020000_cancellation_preserves_unknown_delivery_outcomes`. The twelve unmerged
  migrations are
...
- The 95 INFO / 0 WARN / 0 ERROR security and 611 INFO / 0 WARN / 0 ERROR
  ...
  repository 285 and are not current-parity evidence.
...
- [ ] Run the read-only
      ...
      review. Rehearse the full 49-migration transition on a Production-shaped
...
- [ ] Re-run the preflight on the 285-row target and require the shared tenant
