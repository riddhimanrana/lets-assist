...
At this guide's current evidence point, the repository candidate has 279
...
- This repository has 279 ordered migrations through
  `20260813011500_lock_project_lifecycle_transactions`; Hosted Development
  Supabase remains at 273 through
  `20260812152300_atomic_csf_post_replies`. The six newest repository migrations
  ...
  `20260813011500_lock_project_lifecycle_transactions` — are not applied to any
  hosted database.
