...
**Release ledger:** the current repository candidate carries 484 ordered migrations through `20260911101007_publish_dvhs_csf_1_2_25`; the private release gitlink is `f03e5a0`. The signed application 1.2.25 source is `fa78eeb753ab0af537490fc2b0b62e7b3bf67a3e`. Production has all 482 migrations and serves usability release `84087a03`. The new Sheet sync and current Home import counts remain a release candidate. Deployment receipts identify the served application separately from this database ledger.
