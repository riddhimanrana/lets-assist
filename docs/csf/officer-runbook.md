...
**Release ledger:** the current repository candidate carries 483 ordered migrations through `20260910232532_csf_sheet_sync_review_queue`; the private release gitlink is `05e0202`. Production has all 482 migrations and serves usability release `84087a03`. The new Sheet sync and current Home import counts remain a release candidate. Deployment receipts identify the served application separately from this database ledger.
