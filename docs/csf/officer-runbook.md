...
**Release ledger:** the current repository candidate carries 478 ordered migrations through `20260910004059_csf_import_application_profile_contacts`; the private release gitlink is `82f2751`. Production has all 478 migrations. Manual account connection and simplified application review were verified on Production release `b1f09bf3`. Deployment receipts identify the served application separately from this database ledger.
