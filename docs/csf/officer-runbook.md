...
**Release ledger:** the current repository candidate carries 487 ordered migrations through `20260911184253_csf_sheet_discussion_transport`. The private release gitlink is `d94bcf2`. Application 1.2.28 adds the Comments column and awaits signed publication. Production still has 482 migrations and serves usability release `84087a03`. New Sheet sync and current Home import counts remain a release candidate. Deployment receipts identify the served application separately from this database ledger.
