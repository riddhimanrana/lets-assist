...
**Release ledger:** the current repository candidate carries 501 ordered migrations through `20260912033551_publish_dvhs_csf_1_2_35`. Its committed private release gitlink is `85fc973`, the signed embedded 1.2.35 source. Publication 501 preserves the reviewed migration 500 schema, including no-comments sync and staff contact search. Production has 498 migrations through `20260912002546_publish_dvhs_csf_1_2_34`, host `f742c18d`, and selected application 1.2.31. Sheet sync remains disabled pending the release and copied-workbook acceptance. See the cleanup register for deployed versions and checks.
