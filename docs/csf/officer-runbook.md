...
**Release ledger:** the unshipped correction contains 497 migrations through `20260911231213_csf_application_retry_canonical_ranges`. Its serving private gitlink is restored to `6b73d090`; the signed application 1.2.32 source remains `a9f528e`. Migration 497 still needs release catalog integration and final review. Production remains at 494 migrations, host `f742c18d`, and selected application 1.2.31. Sheet sync remains disabled pending copied-workbook acceptance. See the cleanup register for deployed versions and checks.
