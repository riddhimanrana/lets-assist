...
- [ ] Re-establish the stable Development alias and prove branch-scoped non-production Supabase parity against the ordered ledger through `20260814001123`; the earlier alias/parity evidence applies only to its historical tree
