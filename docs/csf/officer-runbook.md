...
**Current status:** this repository carries 315 ordered migrations through `20260817133000_consolidate_plugin_version_read_policies`; Production was last verified read-only at 236 through `20260811001500`, leaving an exact repository-pinned 79-migration cutover. Hosted Development served exact merge SHA `59f916ad30b423137ae2134ca4b516a8938714f1` with the 314-migration predecessor ledger; the single policy-consolidation follow-up, final browser role acceptance, and provider acceptance remain pending release gates. The fresh full 315-migration local replay must pass before promotion. Google OAuth and Picker were previously connected for a bounded Spring 2026 application preview that committed zero applications. Production remains untouched, and schema deployment or real-data mutation requires separate explicit action-time approval.
...
- [ ] Deploy the policy-consolidation follow-up and prove branch-scoped non-production Supabase parity against the ordered ledger through `20260817133000`; exact alias and 314-row parity are established only for predecessor merge SHA `59f916ad30b423137ae2134ca4b516a8938714f1`
