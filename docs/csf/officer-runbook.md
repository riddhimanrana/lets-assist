...
**Release ledger:** the repository carries 478 ordered migrations through `20260910004059_csf_import_application_profile_contacts`. Production has all 478 migrations. Manual account connection and simplified application review were verified on Production release `b1f09bf3`. The committed gitlink identifies the private plugin version; deployment receipts identify the served application separately from this database ledger.
