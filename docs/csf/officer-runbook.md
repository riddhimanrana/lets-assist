...
**Release ledger:** the candidate carries 489 ordered migrations through `20260911195446_csf_sheet_sync_review_recovery`. Application 1.2.29 adds verified recovery for interrupted Comments exports and record-specific discussion permissions. Its signed publication is pending. Production still has 482 migrations and serves usability release `84087a03`. New Sheet sync and current Home import counts remain a release candidate. See the cleanup register for deployed versions and checks.
