...
**Release ledger:** the current repository candidate carries 498 ordered migrations through `20260912002546_publish_dvhs_csf_1_2_34`. Its private release gitlink is `bb7029d`, the signed embedded 1.2.34 source. Publication 498 preserves the reviewed migration 497 schema; final integrated acceptance remains outstanding. Production remains at 494 migrations, host `f742c18d`, and selected application 1.2.31. Sheet sync remains disabled pending copied-workbook acceptance. See the cleanup register for deployed versions and checks.
