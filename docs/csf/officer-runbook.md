...
**Release ledger:** the current repository candidate carries 503 ordered migrations through `20260913012424_publish_dvhs_csf_1_2_37`. Its committed private release gitlink is `1842776`, the signed embedded 1.2.37 source. Publication 503 preserves the reviewed 502 schema. Production has 502 migrations through `20260912064503_publish_dvhs_csf_1_2_36`, host `caaafa8b`, and selected embedded CSF 1.2.36. Live Sheet sync remains disabled pending the release and copied-workbook acceptance. See the cleanup register for deployed versions and checks.
