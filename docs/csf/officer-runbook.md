...
**Release ledger:** the current repository candidate carries 472 ordered migrations through `20260909163547_csf_directory_prefers_active_class`; the private release gitlink is `f18d868`. Production has all 472 migrations. The account-connection shortcut passed private CI and was verified on the live Production deployment.
