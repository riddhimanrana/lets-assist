...
**Ownership correction deployed:** Production separates reported contacts from ownership evidence and requires independently verified account connections. The two legacy connections await staff review. Workbook refresh and import processing are enabled; outbound email and scheduled publishing remain disabled. See the cleanup register for exact release evidence and current reconciliation counts.
