...
**Release ledger:** the current repository candidate carries 496 ordered migrations through `20260911223138_csf_application_retry_range_expansion`. The private release gitlink is `a9f528e`. Signed application 1.2.32 fixes private workbook copying. Production has 494 migrations, host `f742c18d`, and selected application 1.2.31. Sheet sync remains disabled pending copied-workbook acceptance. See the cleanup register for deployed versions and checks.
