...
- The repository candidate has 356 ordered migrations through
  `20260822224500_lease_historical_plugin_application_runtimes`. The preceding releases publish signed
  ...
  `20260822224500_lease_historical_plugin_application_runtimes`).
- Hosted Development is migration-current at 353 rows through
  ...
  the 354th through 356th migrations above. Google OAuth is enabled and the hosted authorize
...
- Production was verified read-only on 2026-08-22 in Supabase project
  ...
  preflight now expects a 23-migration cutover to this 356-row candidate. Running that cutover requires
