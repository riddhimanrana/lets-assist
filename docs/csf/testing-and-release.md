...
- The repository candidate has 359 ordered migrations through
  `20260822234500_clear_uninstalled_plugin_application_runtime`. The preceding releases publish signed
  ...
  `20260822154500_make_plugin_deployment_urls_immutable`, and
  `20260822224500_lease_historical_plugin_application_runtimes`, and
  `20260822231000_stop_disabled_plugin_application_leases`, and
  `20260822233000_bound_historical_plugin_runtime_grace`, and
  `20260822234500_clear_uninstalled_plugin_application_runtime`).
- Hosted Development is migration-current at 353 rows through
  ...
  the 354th through 359th migrations above. Google OAuth is enabled and the hosted authorize
...
- Production was verified read-only on 2026-08-22 in Supabase project
  ...
  preflight now expects a 26-migration cutover to this 359-row candidate. Running that cutover requires
