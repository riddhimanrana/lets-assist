...
branch at `d4188dd7`; the current root gitlink `605342c` contains that reply
code, the later preview-summary correction, and inactive-access hardening.
Audited source evidence passes
