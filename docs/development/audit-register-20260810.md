...
| [AUD-015](#aud-015) | P1  | Hours publication      | Certificate publication trusts client identity and commits database/provider work non-atomically                       | **Fixed on `development`**; provider settlement gates remain      |
