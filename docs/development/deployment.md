...
reviewed migration `20260905202837`. It accepts explicit
...
The controller checks its SQL hash and all 448 preceding ledger versions.
It applies the migration and its exact ledger entry in one transaction,
