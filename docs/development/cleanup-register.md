...
- P2 fix prepared: the connected Sheet view puts status and student matches first, with configuration and recovery controls under Advanced. Application and point review use the page scrollbar; Up/Down no longer switch students.
