...
`20260812152300`; this repository candidate has 274 through `20260812215733`.
Production therefore has exactly 38 candidate pending migrations.
...
3. **Verify it is a clone, not a replay** — `list_migrations` on the new ref.
   - **236 rows, head `20260811001500`** → a genuine current-baseline clone.
     Continue.
   - **274 rows, head `20260812215733`** → it was built by replaying the
