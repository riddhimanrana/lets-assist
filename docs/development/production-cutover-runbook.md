...
`20260812152300`; this repository has 280 through `20260813010000`. Production
...
context rather than part of the current 44-migration pending set.
...
3. **Verify it is a clone, not a replay** — `list_migrations` on the new ref.
   - **236 rows, head `20260811001500`** → a genuine current-baseline clone.
     Continue.
   - **280 rows, head `20260813010000`** → it was built by replaying the
