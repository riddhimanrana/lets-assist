...
`20260812152300`; this repository has 275 through `20260812193400`. Production
therefore has exactly 39
...
ledger is also two migrations behind this repository and does not prove the
Production-shaped 236→275 transition. It does not exercise
...
3. **Verify it is a clone, not a replay** — `list_migrations` on the new ref.
   - **236 rows, head `20260811001500`** → a genuine current-baseline clone.
     Continue.
   - **275 rows, head `20260812193400`** → it was built by replaying the
