...
`20260812152300`; this repository has 274 through `20260812185500`. Production
therefore has exactly 38
...
ledger is also one migration behind this repository and does not prove the
Production-shaped 236→274 transition. It does not exercise
...
3. **Verify it is a clone, not a replay** — `list_migrations` on the new ref.
   - **236 rows, head `20260811001500`** → a genuine current-baseline clone.
     Continue.
   - **274 rows, head `20260812185500`** → it was built by replaying the
