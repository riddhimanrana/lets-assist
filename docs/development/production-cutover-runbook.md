...
`20260812152300`; this repository candidate has 275 through `20260813011500`.
Production therefore has exactly 39 candidate pending migrations.
...
3. **Verify it is a clone, not a replay** — `list_migrations` on the new ref.
   - **236 rows, head `20260811001500`** → a genuine current-baseline clone.
     Continue.
   - **275 rows, head `20260813011500`** → it was built by replaying the
