...
SELECT extensions.is((SELECT reported_application_personal_email FROM plugin_data.csf_profiles WHERE organization_id='cfc10000-0000-4000-8000-000000000001' AND last_name='Fixture5'),'agree@local.test','agreeing contacts normalize into one personal address');
SELECT extensions.is((SELECT reported_application_personal_email FROM plugin_data.csf_profiles WHERE organization_id='cfc10000-0000-4000-8000-000000000001' AND last_name='Fixture6'),'preferred@local.test','preferred contact takes precedence over a distinct response address');
...
SELECT extensions.ok((SELECT reported_application_school_email IS NULL FROM plugin_data.csf_profiles WHERE organization_id='cfc10000-0000-4000-8000-000000000001' AND last_name='Fixture6'),'response email is not mislabeled as school email');
SELECT extensions.ok((SELECT reported_application_personal_email IS NULL AND reported_application_school_email IS NULL FROM plugin_data.csf_profiles WHERE organization_id='cfc10000-0000-4000-8000-000000000001' AND last_name='Fixture7'),'blank addresses stay absent');
SELECT extensions.ok((SELECT reported_application_personal_email IS NULL AND reported_application_school_email IS NULL FROM plugin_data.csf_profiles WHERE organization_id='cfc10000-0000-4000-8000-000000000001' AND last_name='Fixture8'),'malformed addresses stay absent');
SELECT extensions.is((SELECT reported_application_school_email FROM plugin_data.csf_profiles WHERE organization_id='cfc10000-0000-4000-8000-000000000001' AND last_name='Fixture9'),'school@students.local.test','explicit school contact is retained');
SELECT extensions.is((SELECT reported_application_personal_email FROM plugin_data.csf_profiles WHERE organization_id='cfc10000-0000-4000-8000-000000000001' AND last_name='Fixture9'),'home@local.test','explicit school and preferred contacts remain separate');
SELECT extensions.is((SELECT reported_application_personal_email FROM plugin_data.csf_profiles WHERE organization_id='cfc10000-0000-4000-8000-000000000001' AND last_name='Fixture10'),'fallback@local.test','declared invalid preferred evidence falls back to valid response');
...
SELECT extensions.ok(NOT EXISTS (SELECT 1 FROM plugin_data.csf_profiles WHERE organization_id='cfc10000-0000-4000-8000-000000000001' AND (school_email IS NOT NULL OR personal_email IS NOT NULL OR normalized_school_email IS NOT NULL OR normalized_personal_email IS NOT NULL)),'application capture creates no canonical identity email');
CREATE TEMP TABLE contact_audit_before AS SELECT count(*) AS total FROM plugin_data.csf_admin_audit_events WHERE organization_id='cfc10000-0000-4000-8000-000000000001' AND action='profile.reported_application_contacts_captured';
...
SELECT extensions.is((SELECT count(*) FROM plugin_data.csf_admin_audit_events WHERE organization_id='cfc10000-0000-4000-8000-000000000001' AND action='profile.reported_application_contacts_captured'),(SELECT total FROM contact_audit_before),'replay adds no contact audit');
...
SELECT plugin_data.csf_fill_application_profile_contacts('cfc10000-0000-4000-8000-000000000001',id,matched_profile_id,'cfc00000-0000-4000-8000-000000000001') FROM plugin_data.csf_sheet_import_rows WHERE organization_id='cfc10000-0000-4000-8000-000000000001' AND job_id='cfc60000-0000-4000-8000-000000000002' AND row_number=6;
SELECT extensions.ok((SELECT personal_email IS NULL FROM plugin_data.csf_profiles WHERE organization_id='cfc10000-0000-4000-8000-000000000001' AND last_name='Fixture6'),'reported contact never fills canonical identity even when shared');
SELECT extensions.is((SELECT reported_application_personal_email FROM plugin_data.csf_profiles WHERE organization_id='cfc10000-0000-4000-8000-000000000001' AND last_name='Fixture6'),'preferred@local.test','reported contact remains available as review context even when shared');
