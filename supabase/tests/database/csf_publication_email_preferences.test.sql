...
UPDATE public.notification_settings SET organization_updates=true WHERE user_id='ec200000-0000-4000-8000-000000000002';
INSERT INTO plugin_data.csf_announcements(id,organization_id,title,body,audience,status,published_at,created_by,updated_by)
VALUES('ec700000-0000-4000-8000-000000000003','ec100000-0000-4000-8000-000000000001','Fictional termless post','Synthetic text.','members','published',now(),'ec200000-0000-4000-8000-000000000001','ec200000-0000-4000-8000-000000000001');
...
VALUES('ec900000-0000-4000-8000-000000000001','ec100000-0000-4000-8000-000000000001','transactional','draft','DVHS CSF','csf@notifications.lets-assist.com','dvhighcsf@gmail.com','Fictional transactional notice','Synthetic body.',repeat('a',64),'ec500000-0000-4000-8000-000000000001','applicants','ec200000-0000-4000-8000-000000000001','publication-admin@local.test',now(),'ec200000-0000-4000-8000-000000000001','publication-admin@local.test',1,'publication-transactional-fixture','{"csf_environment":"local"}');
...
INSERT INTO plugin_data.csf_announcements(id,organization_id,title,body,audience,status,published_at,created_by,updated_by)
VALUES('ec700000-0000-4000-8000-000000000004','ec100000-0000-4000-8000-000000000001','Fictional staff post','Synthetic text.','officers','published',now(),'ec200000-0000-4000-8000-000000000001','ec200000-0000-4000-8000-000000000001');
