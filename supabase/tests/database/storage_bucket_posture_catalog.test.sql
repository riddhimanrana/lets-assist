  ...
  $$
    ...
    FROM (
      VALUES
        ...
        ('project-documents'::text, true, 20971520::bigint, ARRAY['application/pdf', 'application/msword', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', 'text/plain', 'image/jpeg', 'image/png', 'image/webp', 'image/jpg']::text[], 'public'::text),
