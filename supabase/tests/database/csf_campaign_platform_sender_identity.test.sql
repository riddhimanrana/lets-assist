...
SELECT extensions.ok(
  ...
  AND pg_get_constraintdef(oid) LIKE '%updates@notifications.lets-assist.com%'
...
SELECT extensions.is(
  ...
  'Sender Identity Chapter|updates@notifications.lets-assist.com|dvhighcsf@gmail.com',
