...
SELECT extensions.is((SELECT count(*)::integer FROM plugin_data.csf_profiles WHERE organization_id='cfc10000-0000-4000-8000-000000000001' AND personal_email='new-applicant@local.test'),1,'the response email is retained as contact without verifying an account');
