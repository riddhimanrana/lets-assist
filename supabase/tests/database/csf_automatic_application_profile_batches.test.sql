...
SELECT extensions.is((SELECT count(*)::integer FROM plugin_data.csf_profiles WHERE organization_id='cfc10000-0000-4000-8000-000000000001' AND (school_email IS NOT NULL OR personal_email IS NOT NULL)),0,'all application addresses remain unverified evidence');
