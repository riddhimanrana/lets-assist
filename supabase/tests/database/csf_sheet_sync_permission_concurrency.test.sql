...
SELECT 'f7100000-0000-4000-8000-000000000001','f7200000-0000-4000-8000-000000000001',permission,true FROM unnest(ARRAY['manage_sheet_sync','export_sensitive_reports','decide_applications','view_applications','write_application_notes','verify_submissions']) permission;
