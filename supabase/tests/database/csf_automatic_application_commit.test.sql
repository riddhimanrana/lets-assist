...
UPDATE plugin_data.csf_profiles SET personal_email=NULL,normalized_personal_email=NULL WHERE organization_id='cfc10000-0000-4000-8000-000000000001' AND last_name='Newapplicant';
...
SELECT extensions.is((SELECT personal_email FROM plugin_data.csf_profiles WHERE organization_id='cfc10000-0000-4000-8000-000000000001' AND last_name='Newapplicant'),'new-applicant@local.test','application commit fills the existing resolved profile blank contact');
...
CREATE TEMP TABLE captured_contacts AS SELECT count(*) AS total FROM plugin_data.csf_admin_audit_events WHERE organization_id='cfc10000-0000-4000-8000-000000000001' AND action='profile.application_contacts_captured';
...
SELECT extensions.is((SELECT count(*) FROM plugin_data.csf_admin_audit_events WHERE organization_id='cfc10000-0000-4000-8000-000000000001' AND action='profile.application_contacts_captured'),(SELECT total FROM captured_contacts),'commit replay adds no duplicate contact audit');
