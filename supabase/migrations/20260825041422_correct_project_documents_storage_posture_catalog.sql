-- The reviewed catalog accidentally narrowed project documents to PDF even
-- though the bucket and every upload validator retain the established project
-- asset formats. Correct the audit projection without changing bucket access.
