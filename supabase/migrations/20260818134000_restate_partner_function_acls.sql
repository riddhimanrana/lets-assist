-- Restate the reviewed ownership and execution boundary for CSF functions
-- replaced by the partner-club simplification migration.
...
GRANT EXECUTE ON FUNCTION plugin_data.csf_reject_recipient_snapshot_mutation() TO service_role;
