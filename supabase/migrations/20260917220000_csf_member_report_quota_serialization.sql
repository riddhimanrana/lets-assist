...
BEGIN
  ...
  -- Lock the shared profile before counting, and keep the verified link stable.
  -- A waiter rechecks the active profile and account status after lock acquisition.
