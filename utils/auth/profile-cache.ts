...
// User type not directly used here - profiles are identified by string id
...
export interface UserProfile {
  ...
  [key: string]: string | boolean | Record<string, unknown> | null | undefined;  // Allow other columns that might be in the DB
}
