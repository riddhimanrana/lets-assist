            ...
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent className="text-xs font-normal">
                  Decide whether this project should record volunteer hours or
                  only collect signups.
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
          </CardTitle>
            ...
            <CardTitle className="flex items-center justify-between">
              ...
              <TooltipProvider>
                <Tooltip>
                  ...
                  />
                  <TooltipContent className="text-xs font-normal">
                    Choose how volunteers will check in and record their hours
                    at your event.
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
            ...
            {isSignupOnly && (
              <Alert className="border-primary/30 bg-primary/5">
                ...
                <AlertDescription className="text-sm">
                  ...
                  still link the signup to an account later.
                </AlertDescription>
              </Alert>
            )}
            ...
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent className="text-xs font-normal max-w-xs">
                  <p>
                    Optional settings that control what volunteers can submit
                    and what is visible publicly.
                  </p>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
          ...
          <CardTitle className="flex items-center justify-between">
            ...
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent className="text-xs font-normal max-w-xs">
                  <p>
                    Upload your organization&apos;s waiver PDF and require
                    volunteers to sign it during signup. Supports e-signatures
                    (draw or type).
                  </p>
                </TooltipContent>
              </Tooltip>
                ...
                {showWaiverReuploadNotice && !hasWaiverPdf && (
                  <Alert className="bg-warning/10 border-warning">
                    ...
                    <AlertDescription className="text-warning text-sm">
                      ...
                      not stored in drafts. Please re-upload your waiver PDF to
                      ...
                      <div className="pt-2">
                        {waiverDefinition ? (
                          <div className="flex items-center gap-2 p-3 border-success rounded-md bg-success/10">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-xs text-muted-foreground">
                                {waiverDefinition.signers.length} signer role(s)
                                defined.
                              </p>
                            </div>
                            {!waiverDisableEsignature && (
                        ...
                        {!waiverDefinition && !waiverDisableEsignature && (
                          <p className="text-xs text-muted-foreground mt-2 text-center">
                            You must configure signature placements before
                            continuing.
                          </p>
                        )}
                      </div>
            ...
            >
              <div className="flex w-full justify-between space-x-3">
                ...
                <div className="flex items-center gap-2">
                  {isPublicVisibilityDisabled && (
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        />
                        <TooltipContent className="text-xs font-normal max-w-xs">
                          Public feed visibility requires Trusted Member
                          approval.
                        </TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
                  ...
                  <Badge
                    variant={
                      isPublicVisibilityDisabled ? "secondary" : "default"
                    }
                  >
                    {isPublicVisibilityDisabled
                      ? "Trusted Members"
          ...
          {isPublicVisibilityDisabled && (
            <Alert className="mt-4 bg-warning/10 border-warning/40">
              ...
              <AlertDescription className="text-sm">
                ...
                <a href="/trusted-member" className="underline text-primary">
                  Apply here
                </a>{" "}
              ...
              <CardTitle className="flex items-center justify-between">
                ...
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent className="text-xs font-normal max-w-xs">
                      <p>
                        Optionally require volunteers to have an email from your
                        organization&apos;s approved domains to sign up.
                      </p>
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
