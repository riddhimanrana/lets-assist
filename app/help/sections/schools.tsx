    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Perfect for California Scholarship Federation and other school
            volunteer programs
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <CardTitle className="text-lg">
                    CSF Hour Requirements Made Easy
                  </CardTitle>
                  <CardDescription>
                    Track and verify the volunteer hours required for CSF
                    membership with built-in verification and reporting.
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
              ...
              <Accordion>
                <AccordionItem value="csf-tracking">
                  ...
                  <AccordionContent className="space-y-2 text-sm">
                    <ul className="list-disc list-inside space-y-1 ml-2">
                      ...
                      <li>
                        Track hours with automatic CSF-compliant documentation
                      </li>
                      <li>
                        Get supervisor verification built into the platform
                      </li>
                      <li>Export CSF-ready reports for school submission</li>
                      <li>
                        Maintain detailed logs of all volunteer activities
                      </li>
                    </ul>
                    <div className="mt-3 p-3 bg-warning/10 rounded-lg">
                      <p className="text-xs">
                        <strong>CSF Tip:</strong> Most CSF programs require
                        10-15 hours per semester with proper documentation and
                        verification.
                      </p>
                    </div>
                  </AccordionContent>
                  ...
                  <AccordionContent className="space-y-2 text-sm">
                    ...
                    <div className="mt-3 p-3 bg-muted/50 rounded-lg">
                      <h6 className="font-medium text-xs mb-1">
                        Not CSF Eligible (typically):
                      </h6>
                      <p className="text-xs text-muted-foreground">
                        Family businesses, court-ordered service, or paid work
                      </p>
                    </div>
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="csf-documentation">
                  ...
                  <AccordionContent className="space-y-3 text-sm">
                    <p>
                      Let&apos;s Assist automatically creates CSF-compliant
                      documentation:
                    </p>
                    <div className="space-y-2">
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">
                            Date, time, location, description, and supervisor
                            info
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">
                            CSV and PDF formats accepted by most schools
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <AccordionItem value="school-setup">
                  ...
                  <AccordionContent className="space-y-2 text-sm">
                    <ol className="list-decimal list-inside space-y-1">
                      ...
                      <li>
                        Set up CSF or other volunteer program requirements
                      </li>
                      <li>
                        Invite students to join your school&apos;s program
                      </li>
                ...
                <AccordionItem value="student-monitoring">
                  ...
                  <AccordionContent className="space-y-2 text-sm">
                    <ul className="list-disc list-inside space-y-1 ml-2">
                      ...
                      <li>
                        Integration capabilities with school information systems
                      </li>
                  ...
                  <AccordionContent className="space-y-3 text-sm">
                    ...
                    <div className="space-y-2">
                      <div className="p-2 border rounded text-xs">
                        <strong>Step 1:</strong> Students submit hours through
                        their projects
                      </div>
                      <div className="p-2 border rounded text-xs">
                        <strong>Step 2:</strong> System notifies designated
                        school staff
                      </div>
                      <div className="p-2 border rounded text-xs">
                        <strong>Step 3:</strong> Review and approve student
                        submissions
                      </div>
                      <div className="p-2 border rounded text-xs">
                        <strong>Step 4:</strong> Generate verified reports for
                        records
                      </div>
                    </div>
                  </AccordionContent>
          ...
          <Card className="border-warning/30 bg-warning/5">
            ...
            <CardContent className="space-y-2 text-sm">
              <ol className="list-decimal list-inside space-y-1">
                <li>
                  Create account and select &quot;Student&quot; role during
                  signup
                </li>
          ...
          <Card className="border-muted">
            <CardHeader>
              <CardTitle className="text-lg">
                Common CSF Questions & Resources
              </CardTitle>
            </CardHeader>
            <CardContent>
              <Accordion>
                <AccordionItem value="csf-requirements">
                  <AccordionTrigger>
                    What are the typical CSF requirements?
                  </AccordionTrigger>
                  <AccordionContent className="space-y-2 text-sm">
                    <p>
                      While requirements vary by school, typical CSF volunteer
                      requirements include:
                    </p>
                    <ul className="list-disc list-inside space-y-1 ml-2">
                      <li>
                        <strong>Hours:</strong> 10-15 hours per semester or
                        20-30 per year
                      </li>
                      <li>
                        <strong>Verification:</strong> Adult supervisor
                        signature or verification
                      </li>
                      <li>
                        <strong>Documentation:</strong> Date, time, location,
                        and activity description
                      </li>
                      <li>
                        <strong>Eligible Activities:</strong> Community service,
                        not personal gain
                      </li>
                      <li>
                        <strong>Deadlines:</strong> Usually by specific dates
                        each semester
                      </li>
                    </ul>
                    <div className="mt-2 p-2 bg-muted/50 rounded text-xs">
                      <strong>Note:</strong> Always check with your specific
                      school&apos;s CSF advisor for exact requirements.
                    </div>
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="csf-verification">
                  <AccordionTrigger>
                    How does verification work for CSF?
                  </AccordionTrigger>
                  <AccordionContent className="space-y-2 text-sm">
                    <p>
                      Let&apos;s Assist provides multiple verification options
                      that meet CSF standards:
                    </p>
                ...
                <AccordionItem value="csf-export">
                  ...
                  <AccordionContent className="space-y-2 text-sm">
                    ...
                    <div className="mt-2 p-2 bg-success/10 rounded text-xs">
                      <strong>Pro Tip:</strong> Export your data regularly
                      throughout the semester rather than waiting until the
                      deadline.
                    </div>
                  </AccordionContent>
                </AccordionItem>
