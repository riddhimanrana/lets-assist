      ...
      return (
        <div className="container max-w-4xl py-6 px-4 mx-auto">
          ...
          <div className="rounded-md border p-4 space-y-2">
            {status === false ? (
              <p>
                It looks like you have already applied to be a Trusted Member
                and were not accepted. Please email support@lets-assist.com for
                further inquiries.
              </p>
            ) : (
              <p>
                Please fill out the Trusted Member form. Once accepted, you will
                have access to create organizations.
              </p>
            )}
