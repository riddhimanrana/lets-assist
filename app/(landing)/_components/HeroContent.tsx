    ...
    <section className="container relative isolate mx-auto w-full overflow-hidden px-4 py-12 md:py-24">
      <div className="grid w-full place-items-center gap-6">
        ...
        >
          {/*<div className="hidden sm:flex justify-center">
            ...
            >
              ...
              <span className="text-center text-foreground/80">
                Won Special Recognition at 2025 Congressional App Challenge
              </span>
            </Badge>
          </div>*/}
          ...
          >
            <h1 className="font-overusedgrotesk text-[2.91rem] font-extrabold leading-[1.1] tracking-tight sm:text-5xl md:text-[3.9rem]">
              Give back to your{" "}
              <span
