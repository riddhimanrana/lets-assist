...
const TARGET_HEAD = "20260817022000";
...
describe("Production cutover preflight source contract", () => {
  test("pins the exact 236 -> 305 ledger and all 69 pending versions", () => {
    ...
    expect(preflight).toContain("count(*) = 305");
    expect(preflight).toContain("min(version::text) = '20260325181408'");
    expect(preflight).toContain("69 migrations pending");
