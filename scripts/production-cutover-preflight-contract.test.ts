...
const TARGET_HEAD = "20260815010000";
...
describe("Production cutover preflight source contract", () => {
  test("pins the exact 236 -> 292 ledger and all 56 pending versions", () => {
    ...
    expect(preflight).toContain("count(*) = 292");
    expect(preflight).toContain("min(version::text) = '20260325181408'");
    expect(preflight).toContain("56 migrations pending");
    expect(preflight).not.toContain("count(*) = 291");
