...
const TARGET_HEAD = "20260817132000";
...
describe("Production cutover preflight source contract", () => {
  test("pins the exact 236 -> 314 ledger and all 78 pending versions", () => {
    ...
    expect(preflight).toContain("count(*) = 314");
    expect(preflight).toContain("min(version::text) = '20260325181408'");
    expect(preflight).toContain("78 migrations pending");
