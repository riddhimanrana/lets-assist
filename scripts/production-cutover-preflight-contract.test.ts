...
const TARGET_HEAD = "20260821052000";
...
describe("Production cutover preflight source contract", () => {
  test("pins the exact 236 -> 343 ledger and all 107 pending versions", () => {
    ...
    expect(preflight).toContain("count(*) = 343");
    expect(preflight).toContain("min(version::text) = '20260325181408'");
    expect(preflight).toContain("107 migrations pending");
