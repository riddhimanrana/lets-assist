...
const TARGET_HEAD = "20260822000923";
...
describe("Production cutover preflight source contract", () => {
  test("pins the exact 236 -> 346 ledger and all 110 pending versions", () => {
    ...
    expect(preflight).toContain("count(*) = 346");
    expect(preflight).toContain("min(version::text) = '20260325181408'");
    expect(preflight).toContain("110 migrations pending");
