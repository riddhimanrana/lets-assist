...
const TARGET_HEAD = "20260822154500";
...
describe("Production cutover preflight source contract", () => {
  test("pins the exact 333 -> 355 ledger and all 22 pending versions", () => {
    ...
    expect(preflight).toContain("count(*) = 355");
    expect(preflight).toContain("min(version::text) = '20260325181408'");
    expect(preflight).toContain("22 migrations pending");
