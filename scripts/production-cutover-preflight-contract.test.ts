...
const TARGET_HEAD = "20260821005258";
...
describe("Production cutover preflight source contract", () => {
  test("pins the exact 236 -> 339 ledger and all 103 pending versions", () => {
    ...
    expect(preflight).toContain("count(*) = 339");
    expect(preflight).toContain("min(version::text) = '20260325181408'");
    expect(preflight).toContain("103 migrations pending");
