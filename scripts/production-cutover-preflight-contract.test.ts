...
const TARGET_HEAD = "20260819002500";
...
describe("Production cutover preflight source contract", () => {
  test("pins the exact 236 -> 330 ledger and all 94 pending versions", () => {
    ...
    expect(preflight).toContain("count(*) = 330");
    expect(preflight).toContain("min(version::text) = '20260325181408'");
    expect(preflight).toContain("94 migrations pending");
