...
const TARGET_HEAD = "20260818160000";
...
describe("Production cutover preflight source contract", () => {
  test("pins the exact 236 -> 325 ledger and all 89 pending versions", () => {
    ...
    expect(preflight).toContain("count(*) = 325");
    expect(preflight).toContain("min(version::text) = '20260325181408'");
    expect(preflight).toContain("89 migrations pending");
