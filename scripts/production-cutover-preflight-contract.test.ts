...
const TARGET_HEAD = "20260822070000";
...
describe("Production cutover preflight source contract", () => {
  test("pins the exact 236 -> 350 ledger and all 114 pending versions", () => {
    ...
    expect(preflight).toContain("count(*) = 350");
    expect(preflight).toContain("min(version::text) = '20260325181408'");
    expect(preflight).toContain("114 migrations pending");
