...
const TARGET_HEAD = "20260822044742";
...
describe("Production cutover preflight source contract", () => {
  test("pins the exact 236 -> 348 ledger and all 112 pending versions", () => {
    ...
    expect(preflight).toContain("count(*) = 348");
    expect(preflight).toContain("min(version::text) = '20260325181408'");
    expect(preflight).toContain("112 migrations pending");
