...
const TARGET_HEAD = "20260821044815";
...
describe("Production cutover preflight source contract", () => {
  test("pins the exact 236 -> 342 ledger and all 106 pending versions", () => {
    ...
    expect(preflight).toContain("count(*) = 342");
    expect(preflight).toContain("min(version::text) = '20260325181408'");
    expect(preflight).toContain("106 migrations pending");
