...
const TARGET_HEAD = "20260820110000";
...
describe("Production cutover preflight source contract", () => {
  test("pins the exact 236 -> 336 ledger and all 100 pending versions", () => {
    ...
    expect(preflight).toContain("count(*) = 336");
    expect(preflight).toContain("min(version::text) = '20260325181408'");
    expect(preflight).toContain("100 migrations pending");
