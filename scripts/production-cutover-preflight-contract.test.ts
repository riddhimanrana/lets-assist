...
const TARGET_HEAD = "20260822134710";
...
describe("Production cutover preflight source contract", () => {
  test("pins the exact 333 -> 353 ledger and all 20 pending versions", () => {
    ...
    expect(preflight).toContain("count(*) = 353");
    expect(preflight).toContain("min(version::text) = '20260325181408'");
    expect(preflight).toContain("20 migrations pending");
