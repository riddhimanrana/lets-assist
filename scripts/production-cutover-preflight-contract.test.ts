...
const TARGET_HEAD = "20260813020000";
...
describe("Production cutover preflight source contract", () => {
  test("pins the exact 236 -> 285 ledger and all 49 pending versions", () => {
    ...
    expect(preflight).toContain("count(*) = 285");
    expect(preflight).toContain("min(version::text) = '20260325181408'");
    expect(preflight).toContain("49 migrations pending");
