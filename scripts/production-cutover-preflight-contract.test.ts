...
const TARGET_HEAD = "20260822084356";
...
describe("Production cutover preflight source contract", () => {
  test("pins the exact 236 -> 352 ledger and all 116 pending versions", () => {
    ...
    expect(preflight).toContain("count(*) = 352");
    expect(preflight).toContain("min(version::text) = '20260325181408'");
    expect(preflight).toContain("116 migrations pending");
