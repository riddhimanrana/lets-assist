...
const TARGET_HEAD = "20260822075815";
...
describe("Production cutover preflight source contract", () => {
  test("pins the exact 236 -> 351 ledger and all 115 pending versions", () => {
    ...
    expect(preflight).toContain("count(*) = 351");
    expect(preflight).toContain("min(version::text) = '20260325181408'");
    expect(preflight).toContain("115 migrations pending");
