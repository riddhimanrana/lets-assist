...
const TARGET_HEAD = "20260822060000";
...
describe("Production cutover preflight source contract", () => {
  test("pins the exact 236 -> 349 ledger and all 113 pending versions", () => {
    ...
    expect(preflight).toContain("count(*) = 349");
    expect(preflight).toContain("min(version::text) = '20260325181408'");
    expect(preflight).toContain("113 migrations pending");
