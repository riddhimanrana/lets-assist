...
const TARGET_HEAD = "20260820130000";
...
describe("Production cutover preflight source contract", () => {
  test("pins the exact 236 -> 338 ledger and all 102 pending versions", () => {
    ...
    expect(preflight).toContain("count(*) = 338");
    expect(preflight).toContain("min(version::text) = '20260325181408'");
    expect(preflight).toContain("102 migrations pending");
