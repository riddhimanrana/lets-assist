...
const TARGET_HEAD = "20260821233000";
...
describe("Production cutover preflight source contract", () => {
  test("pins the exact 236 -> 345 ledger and all 109 pending versions", () => {
    ...
    expect(preflight).toContain("count(*) = 345");
    expect(preflight).toContain("min(version::text) = '20260325181408'");
    expect(preflight).toContain("109 migrations pending");
