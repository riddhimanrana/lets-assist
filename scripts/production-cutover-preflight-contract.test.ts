...
const TARGET_HEAD = "20260822151500";
...
describe("Production cutover preflight source contract", () => {
  test("pins the exact 333 -> 354 ledger and all 21 pending versions", () => {
    ...
    expect(preflight).toContain("count(*) = 354");
    expect(preflight).toContain("min(version::text) = '20260325181408'");
    expect(preflight).toContain("21 migrations pending");
