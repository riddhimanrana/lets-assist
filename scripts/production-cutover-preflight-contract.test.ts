...
const TARGET_HEAD = "20260817050000";
...
describe("Production cutover preflight source contract", () => {
  test("pins the exact 236 -> 308 ledger and all 72 pending versions", () => {
    ...
    expect(preflight).toContain("count(*) = 308");
    expect(preflight).toContain("min(version::text) = '20260325181408'");
    expect(preflight).toContain("72 migrations pending");
