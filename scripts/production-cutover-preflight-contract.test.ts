...
const TARGET_HEAD = "20260818170000";
...
describe("Production cutover preflight source contract", () => {
  test("pins the exact 236 -> 326 ledger and all 90 pending versions", () => {
    ...
    expect(preflight).toContain("count(*) = 326");
    expect(preflight).toContain("min(version::text) = '20260325181408'");
    expect(preflight).toContain("90 migrations pending");
