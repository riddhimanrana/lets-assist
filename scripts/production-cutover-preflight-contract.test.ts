...
const TARGET_HEAD = "20260822032423";
...
describe("Production cutover preflight source contract", () => {
  test("pins the exact 236 -> 347 ledger and all 111 pending versions", () => {
    ...
    expect(preflight).toContain("count(*) = 347");
    expect(preflight).toContain("min(version::text) = '20260325181408'");
    expect(preflight).toContain("111 migrations pending");
