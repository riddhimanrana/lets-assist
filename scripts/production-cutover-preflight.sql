-- Production 236 -> repository target 340 cutover preflight.
--
...
--   post-cutover  340 rows headed by 20260821024024 with the exact 104-row tail
--
...
\echo '    PASS: exactly 236/baseline or exactly 340/target'
\echo '=============================================================='
...
SELECT
  ...
  count(*) = 340
    AND min(version::text) = '20260325181408'
    AND max(version::text) = '20260821024024'
    AND :'baseline_versions_exact'::boolean
    AND (
...
\if :baseline_ledger
  ...
  \echo 'PASS L0: exact Production baseline; 104 migrations pending.'
\elif :target_ledger
