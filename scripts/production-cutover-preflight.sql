-- Production 236 -> repository target 342 cutover preflight.
--
...
--   post-cutover  342 rows headed by 20260821044815 with the exact 106-row tail
--
...
\echo '    PASS: exactly 236/baseline or exactly 342/target'
\echo '=============================================================='
...
SELECT
  ...
  count(*) = 342
    AND min(version::text) = '20260325181408'
    AND max(version::text) = '20260821044815'
    AND :'baseline_versions_exact'::boolean
    AND (
...
\if :baseline_ledger
  ...
  \echo 'PASS L0: exact Production baseline; 106 migrations pending.'
\elif :target_ledger
