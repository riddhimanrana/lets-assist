-- Production 236 -> repository target 289 cutover preflight.
--
...
--   post-cutover  289 rows headed by 20260813091801 with the exact 53-row tail
--
...
\echo '    PASS: exactly 236/baseline or exactly 289/target'
\echo '=============================================================='
...
SELECT
  ...
  count(*) = 289
    AND min(version::text) = '20260325181408'
    AND max(version::text) = '20260813091801'
    AND :'baseline_versions_exact'::boolean
    AND (
...
\if :baseline_ledger
  ...
  \echo 'PASS L0: exact Production baseline; 53 migrations pending.'
\elif :target_ledger
