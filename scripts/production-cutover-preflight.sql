-- Production 236 -> repository target 288 cutover preflight.
--
...
--   post-cutover  288 rows headed by 20260813085442 with the exact 52-row tail
--
...
\echo '    PASS: exactly 236/baseline or exactly 288/target'
\echo '=============================================================='
...
SELECT
  ...
  count(*) = 288
    AND min(version::text) = '20260325181408'
    AND max(version::text) = '20260813085442'
    AND :'baseline_versions_exact'::boolean
    AND (
...
\if :baseline_ledger
  ...
  \echo 'PASS L0: exact Production baseline; 52 migrations pending.'
\elif :target_ledger
