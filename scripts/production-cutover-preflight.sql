-- Production 236 -> repository target 319 cutover preflight.
--
...
--   post-cutover  319 rows headed by 20260818064000 with the exact 83-row tail
--
...
\echo '    PASS: exactly 236/baseline or exactly 319/target'
\echo '=============================================================='
...
SELECT
  ...
  count(*) = 319
    AND min(version::text) = '20260325181408'
    AND max(version::text) = '20260818064000'
    AND :'baseline_versions_exact'::boolean
    AND (
...
\if :baseline_ledger
  ...
  \echo 'PASS L0: exact Production baseline; 83 migrations pending.'
\elif :target_ledger
