-- Production 236 -> repository target 318 cutover preflight.
--
...
--   post-cutover  318 rows headed by 20260818040246 with the exact 82-row tail
--
...
\echo '    PASS: exactly 236/baseline or exactly 318/target'
\echo '=============================================================='
...
SELECT
  ...
  count(*) = 318
    AND min(version::text) = '20260325181408'
    AND max(version::text) = '20260818040246'
    AND :'baseline_versions_exact'::boolean
    AND (
...
\if :baseline_ledger
  ...
  \echo 'PASS L0: exact Production baseline; 82 migrations pending.'
\elif :target_ledger
