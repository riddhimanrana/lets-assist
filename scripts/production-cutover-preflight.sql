-- Production 236 -> repository target 326 cutover preflight.
--
...
--   post-cutover  326 rows headed by 20260818170000 with the exact 90-row tail
--
...
\echo '    PASS: exactly 236/baseline or exactly 326/target'
\echo '=============================================================='
...
SELECT
  ...
  count(*) = 326
    AND min(version::text) = '20260325181408'
    AND max(version::text) = '20260818170000'
    AND :'baseline_versions_exact'::boolean
    AND (
...
\if :baseline_ledger
  ...
  \echo 'PASS L0: exact Production baseline; 90 migrations pending.'
\elif :target_ledger
