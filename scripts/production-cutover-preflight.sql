-- Production 333 -> repository target 358 cutover preflight.
--
...
--   post-cutover  358 rows headed by 20260822233000 with the exact 25-row tail
--
...
\echo '    PASS: exactly 333/baseline or exactly 358/target'
\echo '=============================================================='
...
SELECT
  ...
  count(*) = 358
    AND min(version::text) = '20260325181408'
    AND max(version::text) = '20260822233000'
    AND :'baseline_versions_exact'::boolean
    AND (
...
\if :baseline_ledger
  ...
  \echo 'PASS L0: exact Production baseline; 25 migrations pending.'
\elif :target_ledger
