-- Production 236 -> repository target 346 cutover preflight.
--
...
--   post-cutover  346 rows headed by 20260822000923 with the exact 110-row tail
--
...
\echo '    PASS: exactly 236/baseline or exactly 346/target'
\echo '=============================================================='
...
SELECT
  ...
  count(*) = 346
    AND min(version::text) = '20260325181408'
    AND max(version::text) = '20260822000923'
    AND :'baseline_versions_exact'::boolean
    AND (
...
\if :baseline_ledger
  ...
  \echo 'PASS L0: exact Production baseline; 110 migrations pending.'
\elif :target_ledger
