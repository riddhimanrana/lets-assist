-- Production 236 -> repository target 343 cutover preflight.
--
...
--   post-cutover  343 rows headed by 20260821052000 with the exact 107-row tail
--
...
\echo '    PASS: exactly 236/baseline or exactly 343/target'
\echo '=============================================================='
...
SELECT
  ...
  count(*) = 343
    AND min(version::text) = '20260325181408'
    AND max(version::text) = '20260821052000'
    AND :'baseline_versions_exact'::boolean
    AND (
...
\if :baseline_ledger
  ...
  \echo 'PASS L0: exact Production baseline; 107 migrations pending.'
\elif :target_ledger
