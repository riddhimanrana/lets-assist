-- Production 333 -> repository target 357 cutover preflight.
--
...
--   post-cutover  357 rows headed by 20260822231000 with the exact 24-row tail
--
...
\echo '    PASS: exactly 333/baseline or exactly 357/target'
\echo '=============================================================='
...
SELECT
  ...
  count(*) = 357
    AND min(version::text) = '20260325181408'
    AND max(version::text) = '20260822231000'
    AND :'baseline_versions_exact'::boolean
    AND (
      ...
      '20260822154500','20260822224500','20260822231000'
