-- Production 236 -> repository target 336 cutover preflight.
--
...
--   post-cutover  336 rows headed by 20260820110000 with the exact 100-row tail
--
...
\echo '    PASS: exactly 236/baseline or exactly 336/target'
\echo '=============================================================='
...
SELECT
  ...
  count(*) = 336
    AND min(version::text) = '20260325181408'
    AND max(version::text) = '20260820110000'
    AND :'baseline_versions_exact'::boolean
    AND (
...
\if :baseline_ledger
  ...
  \echo 'PASS L0: exact Production baseline; 100 migrations pending.'
\elif :target_ledger
