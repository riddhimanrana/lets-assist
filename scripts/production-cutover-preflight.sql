-- Production 333 -> repository target 353 cutover preflight.
--
...
--   post-cutover  353 rows headed by 20260822134710 with the exact 20-row tail
--
...
\echo '    PASS: exactly 333/baseline or exactly 353/target'
\echo '=============================================================='
...
SELECT
  ...
  count(*) = 353
    AND min(version::text) = '20260325181408'
    AND max(version::text) = '20260822134710'
    AND :'baseline_versions_exact'::boolean
    AND (
      ...
      '20260822075815','20260822084356','20260822134710'
...
\if :baseline_ledger
  ...
  \echo 'PASS L0: exact Production baseline; 20 migrations pending.'
\elif :target_ledger
