-- Production 236 -> repository target 350 cutover preflight.
--
...
--   post-cutover  350 rows headed by 20260822070000 with the exact 114-row tail
--
...
\echo '    PASS: exactly 236/baseline or exactly 350/target'
\echo '=============================================================='
...
SELECT
  ...
  count(*) = 350
    AND min(version::text) = '20260325181408'
    AND max(version::text) = '20260822070000'
    AND :'baseline_versions_exact'::boolean
    AND (
...
\if :baseline_ledger
  ...
  \echo 'PASS L0: exact Production baseline; 114 migrations pending.'
\elif :target_ledger
