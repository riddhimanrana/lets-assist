...
--   post-cutover  275 rows headed by 20260812193400 with the exact 39-row tail
--
...
SELECT
  ...
  count(*) = 275
    AND min(version::text) = '20260325181408'
    AND max(version::text) = '20260812193400'
    AND :'baseline_versions_exact'::boolean
    AND (
      ...
      '20260812152300','20260812185500','20260812193400'
