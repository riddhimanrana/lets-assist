-- Production 236 -> repository target 327 cutover preflight.
--
...
--   post-cutover  327 rows headed by 20260818180000 with the exact 91-row tail
--
...
\echo '    PASS: exactly 236/baseline or exactly 327/target'
\echo '=============================================================='
...
SELECT
  ...
  count(*) = 327
    AND min(version::text) = '20260325181408'
    AND max(version::text) = '20260818180000'
    AND :'baseline_versions_exact'::boolean
    AND (
...
\if :baseline_ledger
  ...
  \echo 'PASS L0: exact Production baseline; 91 migrations pending.'
\elif :target_ledger
