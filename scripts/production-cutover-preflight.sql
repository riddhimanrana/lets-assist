-- Production 236 -> repository target 325 cutover preflight.
--
...
--   post-cutover  325 rows headed by 20260818160000 with the exact 89-row tail
--
...
\echo '    PASS: exactly 236/baseline or exactly 325/target'
\echo '=============================================================='
...
SELECT
  ...
  count(*) = 325
    AND min(version::text) = '20260325181408'
    AND max(version::text) = '20260818160000'
    AND :'baseline_versions_exact'::boolean
    AND (
...
\if :baseline_ledger
  ...
  \echo 'PASS L0: exact Production baseline; 89 migrations pending.'
\elif :target_ledger
