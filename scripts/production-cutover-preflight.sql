-- Production 236 -> repository target 345 cutover preflight.
--
...
--   post-cutover  345 rows headed by 20260821233000 with the exact 109-row tail
--
...
\echo '    PASS: exactly 236/baseline or exactly 345/target'
\echo '=============================================================='
...
SELECT
  ...
  count(*) = 345
    AND min(version::text) = '20260325181408'
    AND max(version::text) = '20260821233000'
    AND :'baseline_versions_exact'::boolean
    AND (
      ...
      '20260821052000','20260821232923','20260821233000'
...
\if :baseline_ledger
  ...
  \echo 'PASS L0: exact Production baseline; 109 migrations pending.'
\elif :target_ledger
