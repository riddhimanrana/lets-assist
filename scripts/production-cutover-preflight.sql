-- Production 236 -> repository target 278 cutover preflight.
--
...
--   post-cutover  278 rows headed by 20260813010000 with the exact 42-row tail
--
...
\echo '    PASS: exactly 236/baseline or exactly 278/target'
\echo '=============================================================='
...
\if :baseline_ledger
  ...
  \echo 'PASS L0: exact Production baseline; 42 migrations pending.'
\elif :target_ledger
