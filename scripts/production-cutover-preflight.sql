-- Production 236 -> repository target 328 cutover preflight.
--
...
--   post-cutover  328 rows headed by 20260818223637 with the exact 92-row tail
--
...
\echo '    PASS: exactly 236/baseline or exactly 328/target'
\echo '=============================================================='
...
SELECT
  ...
  count(*) = 328
    AND min(version::text) = '20260325181408'
    AND max(version::text) = '20260818223637'
    AND :'baseline_versions_exact'::boolean
    AND (
...
\if :baseline_ledger
  ...
  \echo 'PASS L0: exact Production baseline; 92 migrations pending.'
\elif :target_ledger
