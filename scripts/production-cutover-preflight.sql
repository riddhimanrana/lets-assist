-- Production 236 -> repository target 329 cutover preflight.
--
...
--   post-cutover  329 rows headed by 20260818232541 with the exact 93-row tail
--
...
\echo '    PASS: exactly 236/baseline or exactly 329/target'
\echo '=============================================================='
...
SELECT
  ...
  count(*) = 329
    AND min(version::text) = '20260325181408'
    AND max(version::text) = '20260818232541'
    AND :'baseline_versions_exact'::boolean
    AND (
...
\if :baseline_ledger
  ...
  \echo 'PASS L0: exact Production baseline; 93 migrations pending.'
\elif :target_ledger
