-- Production 236 -> repository target 348 cutover preflight.
--
...
--   post-cutover  348 rows headed by 20260822044742 with the exact 112-row tail
--
...
\echo '    PASS: exactly 236/baseline or exactly 348/target'
\echo '=============================================================='
...
SELECT
  ...
  count(*) = 348
    AND min(version::text) = '20260325181408'
    AND max(version::text) = '20260822044742'
    AND :'baseline_versions_exact'::boolean
    AND (
...
\if :baseline_ledger
  ...
  \echo 'PASS L0: exact Production baseline; 112 migrations pending.'
\elif :target_ledger
