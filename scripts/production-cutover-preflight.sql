-- Production 236 -> repository target 281 cutover preflight.
--
...
--   post-cutover  281 rows headed by 20260813011000 with the exact 45-row tail
--
...
-- Pull requests #152, #174, and #179 are merged in current development;
-- #158 and #175 remain open with later or interleaving versions. This pin is
...
\echo '    PASS: exactly 236/baseline or exactly 281/target'
\echo '=============================================================='
...
SELECT
  ...
  count(*) = 281
    AND min(version::text) = '20260325181408'
    AND max(version::text) = '20260813011000'
    AND :'baseline_versions_exact'::boolean
    AND (
      ...
      '20260812225436','20260813010000','20260813011000'
...
\if :baseline_ledger
  ...
  \echo 'PASS L0: exact Production baseline; 45 migrations pending.'
\elif :target_ledger
