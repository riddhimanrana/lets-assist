-- Production 236 -> repository target 341 cutover preflight.
--
...
--   post-cutover  341 rows headed by 20260821041738 with the exact 105-row tail
--
...
\echo '    PASS: exactly 236/baseline or exactly 341/target'
\echo '=============================================================='
...
SELECT
  ...
  count(*) = 341
    AND min(version::text) = '20260325181408'
    AND max(version::text) = '20260821041738'
    AND :'baseline_versions_exact'::boolean
    AND (
      ...
      '20260821005258','20260821024024','20260821041738'
...
\if :baseline_ledger
  ...
  \echo 'PASS L0: exact Production baseline; 105 migrations pending.'
\elif :target_ledger
