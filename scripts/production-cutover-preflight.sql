-- Production 333 -> repository target 354 cutover preflight.
--
...
--   post-cutover  354 rows headed by 20260822151500 with the exact 21-row tail
--
...
\echo '    PASS: exactly 333/baseline or exactly 354/target'
\echo '=============================================================='
...
SELECT
  ...
  count(*) = 354
    AND min(version::text) = '20260325181408'
    AND max(version::text) = '20260822151500'
    AND :'baseline_versions_exact'::boolean
    AND (
...
\if :baseline_ledger
  ...
  \echo 'PASS L0: exact Production baseline; 21 migrations pending.'
\elif :target_ledger
