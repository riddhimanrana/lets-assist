-- Production 236 -> repository target 347 cutover preflight.
--
...
--   post-cutover  347 rows headed by 20260822032423 with the exact 111-row tail
--
...
\echo '    PASS: exactly 236/baseline or exactly 347/target'
\echo '=============================================================='
...
SELECT
  ...
  count(*) = 347
    AND min(version::text) = '20260325181408'
    AND max(version::text) = '20260822032423'
    AND :'baseline_versions_exact'::boolean
    AND (
...
\if :baseline_ledger
  ...
  \echo 'PASS L0: exact Production baseline; 111 migrations pending.'
\elif :target_ledger
