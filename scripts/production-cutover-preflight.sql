-- Production 236 -> repository target 339 cutover preflight.
--
...
--   post-cutover  339 rows headed by 20260821005258 with the exact 103-row tail
--
...
\echo '    PASS: exactly 236/baseline or exactly 339/target'
\echo '=============================================================='
...
SELECT
  ...
  count(*) = 339
    AND min(version::text) = '20260325181408'
    AND max(version::text) = '20260821005258'
    AND :'baseline_versions_exact'::boolean
    AND (
...
\if :baseline_ledger
  ...
  \echo 'PASS L0: exact Production baseline; 103 migrations pending.'
\elif :target_ledger
