-- Production 236 -> repository target 320 cutover preflight.
--
...
--   post-cutover  320 rows headed by 20260818074500 with the exact 84-row tail
--
...
\echo '    PASS: exactly 236/baseline or exactly 320/target'
\echo '=============================================================='
...
SELECT
  ...
  count(*) = 320
    AND min(version::text) = '20260325181408'
    AND max(version::text) = '20260818074500'
    AND :'baseline_versions_exact'::boolean
    AND (
...
\if :baseline_ledger
  ...
  \echo 'PASS L0: exact Production baseline; 84 migrations pending.'
\elif :target_ledger
