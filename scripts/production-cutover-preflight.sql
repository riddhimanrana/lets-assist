-- Production 236 -> repository target 349 cutover preflight.
--
...
--   post-cutover  349 rows headed by 20260822044742 with the exact 113-row tail
--
...
\echo '    PASS: exactly 236/baseline or exactly 349/target'
\echo '=============================================================='
...
SELECT
  ...
  count(*) = 349
    AND min(version::text) = '20260325181408'
    AND max(version::text) = '20260822060000'
    AND :'baseline_versions_exact'::boolean
    AND (
      ...
      '20260822032423','20260822044742','20260822060000'
...
\if :baseline_ledger
  ...
  \echo 'PASS L0: exact Production baseline; 113 migrations pending.'
\elif :target_ledger
