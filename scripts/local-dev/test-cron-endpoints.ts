 ...
 *
 * Scope: the twelve selected worker routes: auto-publish-hours,
 ...
 * csf-scheduled-post-publisher, and
 * project-feedback-followups, paper-signup-notifications, and csf-publication-notifications.
 *
 ...
 *
 * What this proves: each of the twelve selected routes authenticates, reaches its
...
/**
 * The twelve selected worker routes, by stable ID, asserted on the wire so a
...
const ROUTES = [
  ...
  { id: "csf-import-commit", path: "/api/cron/csf-import-commit" },
  {
  ...
  {
    id: "paper-signup-notifications",
    path: "/api/cron/paper-signup-notifications",
  },
  {
    id: "csf-publication-notifications",
