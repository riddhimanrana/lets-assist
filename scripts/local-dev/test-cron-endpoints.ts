 ...
 *
 * Scope: the eleven selected worker routes: auto-publish-hours,
 ...
 * project-feedback-followups, and paper-signup-notifications.
 *
 ...
 *
 * What this proves: each of the eleven selected routes authenticates, reaches its
...
/**
 * The eleven selected worker routes, by stable ID, asserted on the wire so a
