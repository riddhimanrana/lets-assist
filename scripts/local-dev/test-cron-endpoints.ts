 ...
 *
 * Scope: the ten selected worker routes: auto-publish-hours,
 ...
 *
 * What this proves: each of the ten selected routes authenticates, reaches its
...
/**
 * The ten selected worker routes, by stable ID, asserted on the wire so a
